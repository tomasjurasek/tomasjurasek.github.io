...
The property *MaxConcurrencyCalls* is also tricky. This property is set up on the [MessageHandlerOptions](https://docs.microsoft.com/en-us/dotnet/api/microsoft.azure.servicebus.messagehandleroptions?view=azure-dotnet).. The *MaxConcurrencyCalls* will start more threads to process more parallel messages.
